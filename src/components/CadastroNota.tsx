      ...
      <section className="cartao">
        ...
        <form className="formulario">
          <div className="campo">
            ...
            <select defaultValue={nota?.tipoNota || "Nota Fiscal Digital"}>
          ...
          <div className="campo">
            ...
            <input type="text" defaultValue={nota?.produto || ""} placeholder="Ex: Notebook Lenovo IdeaPad" />
          </div>

          <div className="campo">
            <label>Nome da Loja</label>
            <input type="text" defaultValue={nota?.loja || ""} placeholder="Ex: FastShop" />
          </div>

          <div className="campo">
            <label>Data de Compra</label>
            <input type="text" defaultValue={nota?.dataCompra || ""} placeholder="Ex: 15/12/25" />
          </div>

          <div className="campo">
            <label>Período de Garantia</label>
            <select defaultValue={nota?.duracaoGarantia || "3 meses"}>
          ...
          <div className="campo">
            ...
            <input type="text" defaultValue={nota?.numeroNota || ""} placeholder="Ex: NF-2024-001234" />
          </div>

          <div className="campo">
            <label>Valor</label>
            <input type="text" defaultValue={nota?.valor || ""} placeholder="Ex: R$ 3.299,00" />
          </div>

          <div className="campo">
            <label>Observações</label>
            <textarea defaultValue={nota?.observacoes || ""} placeholder="Informações adicionais sobre a garantia."></textarea>
          </div>
