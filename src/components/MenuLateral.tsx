        ...
        <div className="layout-container">
            ...
            <aside className={`sidebar ${isSidebarOpen ? 'sidebar-open' : ''}`}>
                ...
                <nav className="sidebar-nav">
                    <button
                        className={`nav-item ${currentPage === 'Visualizar Notas' ? 'nav-item-active' : ''}`}
                    ...
                    <button className="nav-item" onClick={() => setIsNotificationsOpen(true)}>
                        <Bell />
                    ...
                    <button
                        className={`nav-item ${currentPage === 'Perfil' ? 'nav-item-active' : ''}`}
            ...
            {isNotificationsOpen && (
                <>
                    <div className="notification-overlay" onClick={() => setIsNotificationsOpen(false)} />
                        ...
                        <div className="notification-list">
                            {notificacoes.map((n, index) => (
                                <div
                                    ...
                                    className={`
                                        notification-item
                                        ${n.tipo === "Expirada" ? "notification-expirada" : "notification-proxima"}
                                ...
                                >
                                    <div>
                                        ...
                                        <p>{n.tipo}</p>
                                        <small>
                                            Compra: {n.dataCompra} • Garantia: {n.duracaoGarantia} meses
                                        </small>
                                    </div>
